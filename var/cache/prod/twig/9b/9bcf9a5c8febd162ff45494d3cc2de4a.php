...
class __TwigTemplate_6f64dedf8800c564714824212c694a8f extends Template
{
    ...
    <div class=\"container-fluid\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["service"]) {
            ...
            if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["service"], "images", [], "any", false, false, false, 53)) > 0)) {
                // line 54
                yield "                                <img src=\"";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/services/mini/300x300-" . CoreExtension::getAttribute($this->env, $this->source, (($__internal_compile_0 = CoreExtension::getAttribute($this->env, $this->source, $context["service"], "images", [], "any", false, false, false, 54)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0[0] ?? null) : null), "name", [], "any", false, false, false, 54))), "html", null, true);
                yield "\" alt=\"";
...
";
    ...
    {
        return new Source("", "employe/service/index.html.twig", "/Applications/MAMP/htdocs/Arcadia-Zoo/templates/employe/service/index.html.twig");
    }
}
