...
class __TwigTemplate_1ad0d5fbc46f5a60b94d7d410ecf89df extends Template
{
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, ($context["habitats"] ?? null), "data", [], "any", false, false, false, 35));
        foreach ($context['_seq'] as $context["_key"] => $context["habitat"]) {
            ...
            if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["habitat"], "images", [], "any", false, false, false, 40)) > 0)) {
                ...
                yield "                                            <img
                                        src=\"";
                // line 42
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/habitats/" . CoreExtension::getAttribute($this->env, $this->source, (($__internal_compile_0 = CoreExtension::getAttribute($this->env, $this->source, $context["habitat"], "images", [], "any", false, false, false, 42)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0[0] ?? null) : null), "name", [], "any", false, false, false, 42))), "html", null, true);
                yield "\" alt=\"";
        ...
        // line 66
        yield "                ";
        $context["pages"] = CoreExtension::getAttribute($this->env, $this->source, ($context["habitats"] ?? null), "pages", [], "any", false, false, false, 66);
        // line 67
        yield "                ";
        $context["currentPage"] = CoreExtension::getAttribute($this->env, $this->source, ($context["habitats"] ?? null), "page", [], "any", false, false, false, 67);
        // line 68
        yield "                ";
...
";
    ...
    {
        return new Source("", "front/habitats/index.html.twig", "/Applications/MAMP/htdocs/Arcadia-Zoo/templates/front/habitats/index.html.twig");
    }
}
