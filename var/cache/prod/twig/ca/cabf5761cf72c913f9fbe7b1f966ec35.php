...
class __TwigTemplate_952793a8ef35d54293b4dd0811d8b40a extends Template
{
    ...
    <div class=\"content-wrapper\">
        ...
        // line 15
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_habitat_delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, ($context["habitat"] ?? null), "id", [], "any", false, false, false, 15)]), "html", null, true);
        yield "\" onsubmit=\"return confirm('Êtes-vous sûr de vouloir supprimer cet élément ?');\">
                            <input type=\"hidden\" name=\"_token\" value=\"";
        // line 16
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete" . CoreExtension::getAttribute($this->env, $this->source, ($context["habitat"] ?? null), "id", [], "any", false, false, false, 16))), "html", null, true);
        yield "\">
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, ($context["habitat"] ?? null), "images", [], "any", false, false, false, 56));
...
";
    ...
    {
        return new Source("", "admin/habitat/edit.html.twig", "/Applications/MAMP/htdocs/Arcadia-Zoo/templates/admin/habitat/edit.html.twig");
    }
}
