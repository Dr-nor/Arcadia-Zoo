...
class __TwigTemplate_9916d39669a1b6a2e8f5665afd9e94b1 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "employe/testimonial/index.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "employe/testimonial/index.html.twig"));
...
<section class=\"content-header\">\t\t\t\t\t
    <div class=\"container-fluid my-2\">
        <div class=\"row mb-2\">
            ...
            <div class=\"col-sm-6 text-right\">
                <a href=\"{{ path('employe_testimonial_new') }}\" class=\"btn btn-primary\">Ajouter un témoignage</a>
            </div>
        </div>
    </div>
</section>
                ...
                <table id=\"testimonialstable\" class=\"table table-hover text-nowrap search-table\">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {# <a class=\"text-success w-4 h-4 mr-3\" href=\"{{ path('employe_testimonial_show', {'id': testimonial.id}) }}\"><i class=\"nav-icon bi bi-eye-fill\"></i></a> #}
                                <a class=\"text-info w-4 h-4\" href=\"{{ path('employe_testimonial_edit', {'id': testimonial.id}) }}\"><i class=\"nav-icon bi bi-pencil-fill\"></i></a>
                                <form class=\"display-inline\" method=\"post\" action=\"{{ path('employe_testimonial_delete', {'id': testimonial.id}) }}\" onsubmit=\"return confirm('Êtes-vous sûr de vouloir supprimer cet élément ?');\">
...
", "employe/testimonial/index.html.twig", "/Applications/MAMP/htdocs/Arcadia-Zoo/templates/employe/testimonial/index.html.twig");
    }
}
