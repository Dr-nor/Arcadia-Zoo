...
class __TwigTemplate_2ea21c4d5ce7f42c9ac4069d6b9b28df extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "employe/service/edit.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "employe/service/edit.html.twig"));
    ...
    <div class=\"content-wrapper\">
        ...
        // line 15
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("employe_service_delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["service"]) || array_key_exists("service", $context) ? $context["service"] : (function () { throw new RuntimeError('Variable "service" does not exist.', 15, $this->source); })()), "id", [], "any", false, false, false, 15)]), "html", null, true);
        ...
        <section class=\"content-header\">
            <div class=\"container-fluid my-2\">
                <div class=\"row mb-2\">
                    ...
                    <div class=\"col-sm-6 text-right d-flex flex-end\">
                        <form class=\"mr-4\" method=\"post\" action=\"{{ path('employe_service_delete', {'id': service.id}) }}\" onsubmit=\"return confirm('Êtes-vous sûr de vouloir supprimer cet élément ?');\">
                            <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ service.id) }}\">
                            <button class=\"btn btn-secondary  ml-3\">Delete</button>
                        </form>
                        <a href=\"{{ path('employe_service_index') }}\" class=\"btn btn-primary\">
                            Retour                                            
                        </a>
                    </div>
                </div>
                                ...
                                <div class=\"mb-3\">
                                    ...
                                    {% for image in service.images %}
                                        <li>
                                            ...
                                            <a  class=\"delete-img\" href=\"{{ path('employe_service_delete_image', {id: image.id}) }}\" data-delete data-token=\"{{ csrf_token('delete' ~ image.id) }}\"><i class=\"nav-icon bi bi-trash-fill\"></i></a>
                                        </li>
                                    {% endfor %}  
                                </ul> 
...
", "employe/service/edit.html.twig", "/Applications/MAMP/htdocs/Arcadia-Zoo/templates/employe/service/edit.html.twig");
    }
}
