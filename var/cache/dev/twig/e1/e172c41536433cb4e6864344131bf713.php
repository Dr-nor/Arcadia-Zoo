...
class __TwigTemplate_c8c6e8bf82f74e4da9c87710ce8d5374 extends Template
{
...
<section class=\"content\">
    ...
    <div class=\"container-fluid\">
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["habitats"]) || array_key_exists("habitats", $context) ? $context["habitats"] : (function () { throw new RuntimeError('Variable "habitats" does not exist.', 49, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["habitat"]) {
            ...
            if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["habitat"], "images", [], "any", false, false, false, 53)) > 0)) {
                // line 54
                yield "                                <img src=\"";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/habitats/mini/300x300-" . CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["habitat"], "images", [], "any", false, false, false, 54), 0, [], "array", false, false, false, 54), "name", [], "any", false, false, false, 54))), "html", null, true);
                yield "\" alt=\"";
...
<section class=\"content-header\">\t\t\t\t\t
    <div class=\"container-fluid my-2\">
        <div class=\"row mb-2\">
            ...
            <div class=\"col-sm-6 text-right\">
                <a href=\"{{ path('app_habitat_new') }}\" class=\"btn btn-primary\">Ajouter un habitat</a>
            </div>
        </div>
    </div>
</section>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <img src=\"{{ asset('uploads/habitats/mini/300x300-' ~ habitat.images[0].name) }}\" alt=\"{{habitat.title}}\" width=\"50\"/>
                                {% else %}
                            ...
                            <td>{{ habitat.title}}</td>
                            <td>{{ habitat.description|striptags|slice(0, 70) ~ '...'}}</td>
                            <td>
                                <a class=\"text-info w-4 h-4\" href=\"{{ path('app_habitat_edit', {'id': habitat.id}) }}\"><i class=\"nav-icon bi bi-pencil-fill\"></i></a>
                                <form class=\"display-inline\" method=\"post\" action=\"{{ path('app_habitat_delete', {'id': habitat.id}) }}\" onsubmit=\"return confirm('Êtes-vous sûr de vouloir supprimer cet élément ?');\">
...
{% endblock %}", "admin/habitat/index.html.twig", "/Applications/MAMP/htdocs/Arcadia-Zoo/templates/admin/habitat/index.html.twig");
    }
}
