 ...
 */
class getRouting_LoaderService extends App_KernelRodDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\Routing\AttributeRouteControllerLoader('rod');

        $a->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($b, 'rod'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($b, 'rod'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($b, 'rod'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($b, 'rod'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($b, 'rod'));
