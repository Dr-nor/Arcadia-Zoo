...
#[Route('veterinary/habitatreport')]
class HabitatreportController extends AbstractController
{
    ...
    #[Route('/', name: 'vet_habitatreport_index', methods: ['GET'])]
    public function index(HabitatreportRepository $habitatreportepository): Response
    {
        return $this->render('veterinary/habitatreport/index.html.twig', [
            'habitatreports' => $habitatreportepository->findBy(['user'=> $this->getUser()]),
        ]);
    }

    #[Route('/new', name: 'vet_habitatreport_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('vet_habitatreport_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->render('veterinary/habitatreport/new.html.twig', [
            'habitatreport' => $Habitatreport,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'vet_habitatreport_show', methods: ['GET'])]
    public function show(Habitatreport $Habitatreport): Response
    {
        return $this->render('veterinary/habitatreport/show.html.twig', [
            'habitatreport' => $Habitatreport,
        ]);
    }

    #[Route('/{id}/edit', name: 'vet_habitatreport_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, Habitatreport $Habitatreport, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('veterinary/habitatreport/edit.html.twig', [
            'habitatreport' => $Habitatreport,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'vet_habitatreport_delete', methods: ['POST'])]
